...
const access_token = '10222605569949330';
    ...
    fetch(`https://superheroapi.com/api.php/${access_token}/${searchID}`)
        ...
        .then(json => {
            ...
            if (json.response === 'error') {
                superImage.src = 'https://media.giphy.com/media/dlMIwDQAxXn1K/giphy.gif';
                nameDiv.innerHTML = '<h3>Not Found! </h3>';
                return;
            }

            superImage.src = 'https://media.giphy.com/media/mWaLPeeQLPT3i/giphy.gif';
